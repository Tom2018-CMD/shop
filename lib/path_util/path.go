 ...
 *
 * This package is used to locate the root directory of goeb5gc project
 * Compatible with Windows and Linux
 *
 * Please import "eb5gc/lib/path_util"
 *
 * Return value:
 * A string value of the relative path between the working directory and the root directory of the goeb5gc project
 *
 * Usage:
 * path_util.Goeb5gcPath("your file location starting with goeb5gc")
 *
 * Example:
 * path_util.Goeb5gcPath("eb5gc/abcdef/abcdef.pem")
 */
func Goeb5gcPath(path string) string {
