...
func (con AlipayController) Alipay(c *gin.Context) {
	...
	client.LoadAppCertPublicKeyFromFile("crt/appCertPublicKey_2021001186696588.crt") // 加载应用公钥证书
	client.LoadAliPayRootCertFromFile("crt/alipayRootCert.crt")                      // 加载支付宝根证书
	client.LoadAlipayCertPublicKeyFromFile("crt/alipayCertPublicKey_RSA2.crt")       // 加载支付宝公钥证书
